package com.yidu.mall.comment.servlet;
...
public class CommentServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if ("addComment".equals(mod)) {  //添加商品评论
			addComment(request,response);
		}else if ("getCommentByProductId".equals(mod)) {   //根据商品获取评论
			getCommentByProductId(request,response);
		}else if ("userComment".equals(mod)) {   //判断登录的用户是否可评论此商品
