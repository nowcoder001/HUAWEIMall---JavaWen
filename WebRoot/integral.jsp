	...
	<div class="g">
        ...
        <div class="myGather-info">
            <div class="myGather-point">
                <dl>
                    <dt>可用积分</dt>
                    <dd><span id="usablePoint">0</span></dd>
                </dl>
            </div>
            <div class="myGather-redeem">
                <dl>
                    <dt>可抵现金</dt>
                    <dd><span id="usableCash">0.00</span><em>元</em></dd>
                </dl>
            </div>
            <div class="myGather-timeout">
                <dl>
                    <dt>将要过期的积分：<span id="expireTime"></span></dt>
                    <dd><span id="expirePoint">0</span></dd>
                </dl>
            </div>
        </div><!-- 20160913-我的积分-信息-end -->
        <div class="hr-50"></div>

        <div class="my-tab">
            <div id="ec-tab-grade" class="ec-tab">
                <ul>
                    <li class="current"><a href="javascript:;" onclick="ec.member.newpoint.tabClick(this,1)"><span>积分说明</span></a></li>
                    <li><a href="javascript:;" onclick="ec.member.newpoint.tabClick(this,2)"><span>常见问题</span></a></li>
                    <li><a href="javascript:;" onclick="ec.member.newpoint.tabClick(this,3)"><span>积分明细</span></a></li>
                </ul>
